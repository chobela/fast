...
<!-- Menu -->
 ...
 <li>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2016 - 2017 <a href="javascript:void(0);">Fast Debt Managers</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 2.0
                </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    DEBTOR SUMMARY
                    <small>Taken from <a href="https://datatables.net/" target="_blank">Summary of all debtors</a></small>
                </h2>
            </div>
            <!-- Basic Examples -->
...
?>
 ...
 <td  style="text-align:center"><a href="pages/contacts.php?id=<?=$uid?>" class="label bg-grey">Contact Details</a></td>
 <td  style="text-align:center"><a href="pages/comments.php?id=<?=$uid?>" class="label bg-grey">Comments</a></td>
 <td  style="text-align:center"><a href="pages/payhistory.php?id=<?=$uid?>" class="label bg-grey">Payments</a></td>
 <td  style="text-align:center"><a href="pages/ptp.php?id=<?=$uid?>" class="label bg-grey">PTP</a></td>
