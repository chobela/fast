        ...
        <div class="container">
            <div class="block-header">
                <h2>
                    ...
                    <small>Chilala Simwambana</small>
                </h2>
            </div>
      
<div style="height:50px;"></div>
	<div class="well" style="margin:auto; padding:auto; width:100%;">
	<span style="font-size:25px; color:blue"><center><strong>Business Development Tracker</strong></center></span>	
		...
		<table class="table table-striped table-bordered table-hover">
			...
			<?php
				...
				$query=mysqli_query($conn,"select * from `development`");
				while($row=mysqli_fetch_array($query)){
					...
					<tr>
						...
						<td><?php echo $row['person']; ?></td>
                                                ...
                                                <td><?php echo $row['rag']; ?></td>
                                                <td><?php echo $row['super_remarks']; ?></td>
                                                <td><?php echo $row['status_remarks']; ?></td>
						<td>
