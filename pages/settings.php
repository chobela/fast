    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../index.php">FAST - DEBT MANAGERS</a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    ...
                    <div class="email">chobela.kakumbi@gmail.com</div>
...
<div class="container-fluid">
     <div class="block-header">
		...
		<div class="well clearfix">
			...
			<span class="glyphicon glyphicon-plus"></span> User</button></div></div>
